        ...
        <div class="container-fluid px-5">
            ...
            <div class="collapse navbar-collapse justify-content-center">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link active" href="signuppage.php">SIGN UP</a>
                </div>
            </div>
            <div class="nav-icons">
    ...
    <div class="main-wrapper">
        <div class="sb-card">
            ...
            <form action="auth.php" method="post">
                ...
                <button type="submit" name="signup" class="btn-purple">SIGN UP</button>
            </form>
            <div class="text-center mt-4">
                <small>Already sign up? <a href="loginpage.php" style="color: #6f42c1; font-weight: bold;">Log
                        In</a></small>
            </div>
        </div>
    </div>
